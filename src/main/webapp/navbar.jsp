    ...
    <div class="collapse navbar-collapse" userId="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" userId="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <li class="nav-item">
                <a href="login-page.jsp" class="btn text-white"><span class="fa fa-user-circle-o"></span> Login</a>
            </li>
            <li class="nav-item">
                <a href="register-page.jsp" class="btn text-white"><span class="fa fa-user-plus"></span> Sign Up</a>
            </li>
        </ul>
